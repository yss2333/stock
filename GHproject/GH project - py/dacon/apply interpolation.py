...
ticker = 'tsla'
## 1. Load data
Income = pd.read_csv(r'C:\Users\yss06\Desktop\python\stock\GHproject\GH project - py\dacon\심화 loaded data\{ticker}_FS_Income.csv')
Cash = pd.read_csv(r'C:\Users\yss06\Desktop\python\stock\GHproject\GH project - py\dacon\심화 loaded data\{ticker}_FS_Cash.csv')
Balance = pd.read_csv(r'C:\Users\yss06\Desktop\python\stock\GHproject\GH project - py\dacon\심화 loaded data\{ticker}_FS_Balance.csv')
Ratio = pd.read_csv(r'C:\Users\yss06\Desktop\python\stock\GHproject\GH project - py\dacon\심화 loaded data\{ticker}_FS_Ratio.csv')
